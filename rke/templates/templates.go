...
const (
	...
	nginxIngressV116 = "nginxingress-v1.16"
...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.NginxIngress: {
			...
			">=1.15.3-rancher2 <1.16.8-rancher1-4":  nginxIngressV115,
			">=1.16.8-rancher1-4":                   nginxIngressV116,
		},
		kdm.Nodelocal: {
...
func getTemplates() map[string]string {
	return map[string]string{
		...
		nginxIngressV116: NginxIngressTemplateV0300Rancher1,
